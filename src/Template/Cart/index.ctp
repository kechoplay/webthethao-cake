...
=======
									...
									<a href="<?=$this->Url->build(['action'=>'delcart',$value['id']])?>">
                                        <button class="btn btn-danger" type="button" onclick="return xacnhanxoa();" name="del">
...
>>>>>>> origin/master
				...
				<tr>
					<td colspan="5" style="text-align:right"><strong>TOTAL (<?=number_format($total)." - ".number_format($totaldiscount); ?>) =</strong></td>
